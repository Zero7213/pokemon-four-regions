...
#define VAR_KANTO_PLAYER_STARTER_SPECIES                 0x40F7 // Oak starter species; SPECIES_NONE until granted
#define VAR_KANTO_RIVAL_STARTER_SPECIES                  0x40F8 // Same-generation, type-advantaged rival starter
